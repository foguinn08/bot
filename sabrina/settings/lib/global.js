...
return `❗ Atenção! o usuário @${menc_os2.split("@")[0]} foi advertido ${dfqn}/3.\n_Ao totalizar 3 advertências, o usuário será banido._`
}

exports.finishAdvertencia = (menc_os2) => {
return `👋 Adeus @${menc_os2.split("@")[0]}\n\nVocê completou 3 advertências e será banido(a) do grupo.`
}
...
return `⏳ Aguarde 5 segundos para executar outro comando...`
}
...
Olá, usuário, o anti-ligação está ativo no momento. Isso significa que estou seguindo a ordem de bloquear usuários que tentarem me ligar. Agradeço pela compreensão.
