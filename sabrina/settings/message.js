...
var mensagens = [
"Estou preparando o envio, aguarde um momento ⏳",
"Estou finalizando, logo estará disponível ⏳",
"Só mais um instante, estou concluindo ⏳",
"O comando está a caminho, aguarde ⏳",
"Seu pedido está sendo processado, em breve estará pronto ⏳",
"Estou quase lá, só um momento ⏳",
"Sua solicitação está em andamento, aguarde um pouco ⏳",
"Estou finalizando, logo estará pronto para envio ⏳",
"O envio está em andamento, aguarde ⏳",
"Estou quase terminando, só mais um instante ⏳",
"Seu pedido está sendo finalizado, aguarde ⏳",
"Estou a caminho, aguarde só um pouco ⏳"
]
...
msg: {
  ...
  mod: '❎ Este comando só pode ser utilizado pelo dono.',
  banido: '❎ Você foi banido e não pode mais utilizar meus comandos.' ,
  donosmt: '❎ Apenas o dono pode utilizar este comando.',
  donosmt2: '❎ Apenas o dono pode utilizar este comando.',
  ...
  modobn: '❎ Este modo só pode ser usado quando o comando *#modobrincadeira* está ativado.'
}
}
