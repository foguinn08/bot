...
case 'connecting':
console.log(colors.yellow(`Reconectando/Iniciando - ${date} ${time}`))
break;

case 'open':
console.log(banner3.string)   
console.log(banner2.string)  
console.log(colors.green(`UnieBOT conectado!`))
//mensagem de conexão 
await sabrina.sendPresenceUpdate("available")
await sabrina.updateProfileStatus(`😳`)
//aq nesse emoji muda o recado que o bot deixa no whatsapp quando ele ativa.
break;
